...
Article.create!(user: User.first, title: "GTA 5", content: "Michael Townley, Trevor Philips, and Brad Snider partake in a botched robbery in Ludendorff, North Yankton. Nine years later, Michael is living under witness protection with his family in Los Santos, under the alias Michael De Santa. Across town, gangbanger Franklin Clinton is working for a corrupt Armenian car salesman and meets Michael while attempting to fraudulently repossess his son's car; the two later become friends. When Michael finds his wife Amanda sleeping with her tennis coach, he and Franklin chase the coach to a mansion, which Michael destroys in anger. The owner turns out to be the girlfriend of Martin Madrazo, a Mexican drug lord who demands compensation to avoid further violence. Michael returns to a life of crime to obtain the money, enlisting Franklin as an accomplice. With the help of Michael's old friend Lester Crest, a disabled hacker, they perform a jewellery shop heist to pay off the debt. Trevor, who now lives in a trailer park on the outskirts of Los Santos, hears of the heist and realises that it was Michael's handiwork; Trevor had believed that Michael was killed in their botched robbery nine years ago. Trevor surprises Michael and reunites with him, after tracking down his home.")
Article.create!(user: User.first, title: "Uncharted collection", content: "UNCHARTED: The Nathan Drake Collection includes the singleplayer campaigns for UNCHARTED: Drake's Fortune, UNCHARTED 2: Among Thieves, and UNCHARTED 3: Drake's Deception. Unparalleled Story  Play as Nathan Drake across a trilogy of thrilling, white-knuckle adventures.")
Article.create!(user: User.first, title: "Tomb raider", content: "Lara Croft, a courageous and independent young woman, sets out on a dangerous journey to unravel the truth behind her adventurer father's mysterious disappearance.")
Article.create!(user: User.first, title: "Diablo 3", content: "Diablo III is a hack-and-slash action role-playing game developed and published by Blizzard Entertainment as the third installment in the Diablo franchise")
Article.create!(user: User.first, title: "Red dead redemption 2", content: "Red Dead Redemption 2 is a 2018 action-adventure game developed and published by Rockstar Games. The game is the third entry in the Red Dead series and is a prequel to the 2010 game Red Dead Redemption.")
Article.create!(user: User.last, title: "Final Fantasy 7 remake", content: "Final Fantasy VII Remake is an upcoming action role-playing game developed and published by Square Enix. The game is a remake of the 1997 PlayStation game Final Fantasy VII.")
Article.create!(user: User.last, title: "Arkham asylum", content: "Batman: Arkham Asylum is a 2009 action-adventure game developed by Rocksteady Studios and published by Eidos Interactive in conjunction with Warner Bros. Interactive Entertainment.")
Article.create!(user: User.last, title: "Destiny 2", content: "Destiny 2 is a free-to-play online-only multiplayer first-person shooter video game developed by Bungie. It was released for PlayStation 4 and Xbox One on September 6, 2017, followed by a Microsoft Windows version the following month.")
Article.create!(user: User.last, title: "No man's sky", content: "No Man's Sky is an exploration survival game developed and published by the indie studio Hello Games. It was released worldwide for the PlayStation 4 and Microsoft Windows in August 2016, and for Xbox One in July 2018. The game is built around four pillars: exploration, survival, combat, and trading.")
Article.create!(user: User.last, title: "Star wars: fallen order", content: "Five years after the execution of Order 66 and the beginning of the Great Jedi Purge, former Jedi Padawan Cal Kestis is in hiding from the newly risen Galactic Empire. On the planet Bracca, where he works as a scrapper salvaging ships from the Clone Wars, Cal uses the Force to save his friend Prauf from falling to his death. The incident is recorded by an Imperial Probe Droid who relays the information to the Empire. The Empire sends two Inquisitors known as the Second Sister and the Ninth Sister to pursue Cal. After they kill Prauf, Cal makes his escape, briefly engaging the Second Sister before being rescued by a former Jedi Knight named Cere Junda and her partner pilot Greez Dritus in their ship, the Stinger Mantis.")
