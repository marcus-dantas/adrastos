...
Article.create!(user: User.first, title: "my third article")
Article.create!(user: User.first, title: "my fourth article")
Article.create!(user: User.first, title: "my fifth article")
Article.create!(user: User.first, title: "my sixth article")
Article.create!(user: User.first, title: "my seventh article")
Article.create!(user: User.first, title: "my eith article")
Article.create!(user: User.first, title: "my nineth article")
Article.create!(user: User.first, title: "my tenth article")
